...
const blank = { id: "", name: "", relation: "", phone: "", primary: false };
      ...
      {state.guardians.map((g) => (
        ...
        >
          ...
          <View style={{ flex: 1, gap: 4 }}>
            ...
            <Txt style={{ color: C.muted, fontSize: 12 }}>☎ {g.phone}</Txt>
          </View>
        ...
        {editing &&
          (confirmRemove ? (
            ...
            <>
              ...
              <Button title="Save guardian" onPress={save} />
              {editing.id && (
                <Button
                  title="Remove guardian"
                  danger
